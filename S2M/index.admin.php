    ...
    <header class="main-header">
        <div class="container container--flex">
          ...
          <p> <?php echo $_SESSION['nombre']; ?>
           ...
           <button type="submit"  onclick="eliminarcuenta()" class="btn btn-danger">Gestionar cuentas</button>
           
           </form>
           <form action="logout.php">
           <button type="submit" onclick="logout()" class="btn btn-danger">Cerrar Sesión</button>
           </form>
          </div>
        </div>
      </header>
